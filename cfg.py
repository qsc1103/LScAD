...
def parse_args():    
    ...
    parser.add_argument('-exp_name', default='mvtec', type=str, help='net type')
    ...
    parser.add_argument('-out_size', type=int, default=224, help='output_size')
    ...
    parser.add_argument('-dataset', default='MVTec' ,type=str,help='dataset name')
    parser.add_argument('-sam_ckpt', default='checkpoint/sam/sam_vit_h_4b8939.pth' , help='sam checkpoint address')
    ...
    parser.add_argument('-data_path', type=str, default='MVtec/', help='The path of segmentation data')
    parser.add_argument('-subclass', default='bottle', type=str, help='subclass name')
    parser.add_argument('-anomaly_source_path', default='anomaly_source/blotchy/', type=str, help='anomaly source path')
